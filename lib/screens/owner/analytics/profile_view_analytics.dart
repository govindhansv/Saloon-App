...
class ProfileViewAnalytics extends StatefulWidget {
  // ignore: prefer_const_constructors_in_immutables
  ProfileViewAnalytics({Key? key}) : super(key: key);

  @override
  ProfileViewAnalyticsState createState() => ProfileViewAnalyticsState();
}

class ProfileViewAnalyticsState extends State<ProfileViewAnalytics> {
