...
class FollowersAnalytics extends StatefulWidget {
  // ignore: prefer_const_constructors_in_immutables
  FollowersAnalytics({Key? key}) : super(key: key);

  @override
  FollowersAnalyticsState createState() => FollowersAnalyticsState();
}

class FollowersAnalyticsState extends State<FollowersAnalytics> {
