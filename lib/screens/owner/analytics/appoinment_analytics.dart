...
class AppoinmentAnalytics extends StatefulWidget {
  // ignore: prefer_const_constructors_in_immutables
  AppoinmentAnalytics({Key? key}) : super(key: key);

  @override
  AppoinmentAnalyticsState createState() => AppoinmentAnalyticsState();
}

class AppoinmentAnalyticsState extends State<AppoinmentAnalytics> {
