...
class CustomersAnalytics extends StatefulWidget {
  // ignore: prefer_const_constructors_in_immutables
  CustomersAnalytics({Key? key}) : super(key: key);

  @override
  CustomersAnalyticsState createState() => CustomersAnalyticsState();
}

class CustomersAnalyticsState extends State<CustomersAnalytics> {
