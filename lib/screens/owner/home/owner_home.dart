                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style:
                                        Theme.of(context).textTheme.displaySmall!.copyWith(color:ColorConstants.textclr),
                                  ),
                                  Text(
                                    snapshot.data[i].description,
                                    textAlign: TextAlign.left,
                                    style:
                                        Theme.of(context).textTheme.titleSmall!.copyWith(color: ColorConstants.textclr),
                                  ),
                                ],
                              ),
                            );
                                      ...
                                      children: [
                                        Text(
                                          ...
                                          style: Theme.of(context)
                                              .textTheme
                                              .titleMedium!.copyWith(color: ColorConstants.textclr),
                                        ),
                                        Text(
                                          snapshot.data[i].username,
                                          textAlign: TextAlign.left,
                                          style: Theme.of(context)
                                              .textTheme
                                              .titleSmall!.copyWith(color:ColorConstants.textclr),
                                        ),
                                        // Text('₹7',
                                        //     textAlign: TextAlign.left,
                                        //     style: Theme.of(context)
