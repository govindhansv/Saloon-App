...
class _ShopBookingPageState extends State<ShopBookingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    for (DateTime time = startTime;
        ...
        time = time.add(const Duration(minutes: timeIntervalInMinutes))) {
      DateTime endTimeForSlot =
          time.add(const Duration(minutes: timeIntervalInMinutes));
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color.fromARGB(235, 238, 238, 238),
                          // boxShadow: [
                          //   BoxShadow(
