...
class UserViewSingleStorePage extends StatefulWidget {
  String title;
  UserViewSingleStorePage({super.key, required this.title});
...
class _UserViewSingleStorePageState extends State<UserViewSingleStorePage> {
  ...
  void onload() async {
    ...
    var response = await http
        .get(Uri.parse('${apidomain}follow/check/${widget.title}/$userid'));
            ...
            child: Column(
              ...
              children: [
                FutureBuilder<http.Response>(
                  future: http.get(
                      Uri.parse('${apidomain}store/store/get/${widget.title}')),
                ...
                FutureBuilder(
                  future: getSingleStoreServices(widget.title),
                    ...
                    if (snapshot.data == null) {
                      ...
                      if (snapshot.data.length == 0) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, i) {
                            return ServiceCardLong3(data: snapshot.data[i]);
                          },
                        );
                      }
                    }
